    ...
    <section className="bg-ctk-950 text-white py-28 sm:py-36">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
          <FadeInOnScroll>
            <span className="text-[10px] tracking-[0.3em] text-white/65 uppercase font-medium mb-4 block">About</span>
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-serif font-bold mb-6 leading-tight">The Studio</h2>
            ...
            <div className="h-80 sm:h-96 md:h-120 bg-gradient-to-br from-ctk-800 to-ctk-700 rounded-sm relative overflow-hidden aspect-[4/3]">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-xs text-white/65 tracking-[0.2em] font-light uppercase">Chadcombe Workshop</p>
